...
namespace Opsive.UltimateCharacterController.Editor.Controls.Types.AbilityDrawers
{
    ...
    public class AbilityControlType : StateObjectControlType
    {
                                                        ...
                                                        int arrayIndex, System.Type type, object value, System.Func<object, bool> onChangeEvent, object userData)
        {
            ...
            FieldInspectorView.AddField(unityObject, target, "m_StateAppendItemIdentifierName", stateNameContainer, (o) => { onChangeEvent(o); }, null, false, null, LabelControl.WidthAdjustment.None);
            ...
            if (abilityDrawer != null) {
                ...
                FieldInspectorView.AddFields(unityObject, target, Shared.Utility.MemberVisibility.Public, container, (o) => { onChangeEvent(o); }, null, null, false, null, LabelControl.WidthAdjustment.UnityDefault);
            }
        ...
        private void ShowAbilityStarter(Object unityObject, object target, VisualElement container, System.Action<object> onChangeEvent)
        {
            ...
            if (s_AbilityStarterTypes != null && s_AbilityStarterTypes.Count > 0) {
                ...
                var labelControl = new LabelControl("Starter", Opsive.Shared.Editor.Utility.EditorUtility.GetTooltip(typeof(Ability).GetField("m_AbilityStarter", BindingFlags.NonPublic | BindingFlags.Instance)), dropdownField, LabelControl.WidthAdjustment.UnityDefault);
        ...
        private void ShowAbilityStopper(Object unityObject, object target, VisualElement container, System.Action<object> onChangeEvent)
        {
            ...
            if (s_AbilityStopperTypes != null && s_AbilityStopperTypes.Count > 0) {
                ...
                var labelControl = new LabelControl("Stopper", Opsive.Shared.Editor.Utility.EditorUtility.GetTooltip(typeof(Ability).GetField("m_AbilityStopper", BindingFlags.NonPublic | BindingFlags.Instance)), dropdownField, LabelControl.WidthAdjustment.UnityDefault);
                labelControl.Q<Label>().AddToClassList("indent");
                container.Add(labelControl);
