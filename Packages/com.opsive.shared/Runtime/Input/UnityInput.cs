...
namespace Opsive.Shared.Input
{
    ...
    public class UnityInput : PlayerInput
    {
        ...
        public ForceInputType ForceInput { get { return m_ForceInput; } 
            set { 
                if (m_ForceInput == value) { return; }

                m_ForceInput = value;
                var useVirtualInput = m_ForceInput == ForceInputType.Virtual;
...
#endif
                if (useVirtualInput == m_UseVirtualInput) {
                    return;
                }

                m_UseVirtualInput = useVirtualInput;
                ...
                Events.EventHandler.ExecuteEvent(gameObject, "OnUnityInputTypeChanged", this, m_UseVirtualInput);
            }
        }
