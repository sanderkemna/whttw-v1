...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class AssistAim : Ability
    {
                ...
                if (m_Target != null) {
                    ...
                    if (m_TargetHumanoidBone) {
                        ...
                        if (modelManager != null) {
                            ...
                            var animationMonitor = m_Target.gameObject.GetComponentInChildren<AnimationMonitorBase>();
        ...
        /// </summary>
        /// <param name="cameraPosition">The current Camera Controller position.</param>
