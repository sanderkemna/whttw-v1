    ...
    public sealed class AssetConnectionUI : PopupWindowContent
    {
        ...
        public override void OnGUI(Rect rect)
        {
            ...
            if (string.IsNullOrWhiteSpace(_url))
            {
                ...
                if (GUILayout.Button("https://assetstore.unity.com/packages/tools/utilities/asset-inventory-226927", EditorStyles.linkLabel))
                {
                    AI.OpenStoreURL("https://assetstore.unity.com/packages/tools/utilities/asset-inventory-226927");
                }
            }
