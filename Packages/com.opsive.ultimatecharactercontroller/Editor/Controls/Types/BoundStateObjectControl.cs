...
namespace Opsive.UltimateCharacterController.Editor.Controls.Types
{
    ...
    /// </summary>
    [ControlType(typeof(BoundStateObject))]
    public class BoundStateObjectControlType : StateObjectControlType
    {
        /// <summary>
        ...
        protected override VisualElement GetControl(TypeControlInput input)
        {
            ...
            var boundStateObject = input.Value as BoundStateObject;
            if (boundStateObject != null) {
                boundStateObject.InitializeStateObjectBindings();
            }
            
            FieldInspectorView.AddField(input.UnityObject, input.Target, "m_Bindings", container, (o) => { input.OnChangeEvent(o); }, null, false, null, LabelControl.WidthAdjustment.UnityDefault, null, input.SerializedProperty.FindPropertyRelative("m_Bindings"));
            FieldInspectorView.AddField(input.UnityObject, input.Target, "m_States", container, (o) => { input.OnChangeEvent(o); }, null, false, null, LabelControl.WidthAdjustment.UnityDefault, null, input.SerializedProperty.FindPropertyRelative("m_States"));
            return container;
        }
                                                        ...
                                                        int arrayIndex, System.Type type, object value, System.Func<object, bool> onChangeEvent, object userData)
        {
            ...
            var baseType = type;
            while (baseType != typeof(BoundStateObject)) {
