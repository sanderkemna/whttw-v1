...
namespace Opsive.UltimateCharacterController.Editor.References
{
    ...
    public class ObjectRemover
    {
        ...
        private static void ProcessScene()
        {
            ...
            var objectReferences = GameObject.FindObjectsByType<ObjectReferences>(FindObjectsSortMode.None);
#else
        ...
        private static void ProcessObjectReferences(ObjectReferences objectReferences, bool fromScene)
        {
            ...
            if (fromScene) {
#if UNITY_2023_1_OR_NEWER
                cameraControllers = GameObject.FindObjectsByType<CameraController>(FindObjectsSortMode.None);
#else
            ...
            if (fromScene) {
#if UNITY_2023_1_OR_NEWER
                characterLocomotions = GameObject.FindObjectsByType<Character.UltimateCharacterLocomotion>(FindObjectsSortMode.None);
#else
            ...
            var shadowCaster = Managers.ManagerUtility.FindInvisibleShadowCaster();
            ...
            if (fromScene) {
#if UNITY_2023_1_OR_NEWER
                stateBehaviors = GameObject.FindObjectsByType<Shared.StateSystem.StateBehavior>(FindObjectsSortMode.None);
#else
