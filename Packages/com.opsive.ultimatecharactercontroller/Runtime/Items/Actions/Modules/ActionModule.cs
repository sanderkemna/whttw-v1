...
namespace Opsive.UltimateCharacterController.Items.Actions.Modules
{
    ...
    public abstract class ActionModule : BoundStateObject, IActionModule
    {
        ...
        public INetworkCharacterInventory NetworkCharacter => m_CharacterItemAction.NetworkCharacter;
#endif
        ...
        public virtual void ResetModule(bool force) { m_Initialized = false; }
