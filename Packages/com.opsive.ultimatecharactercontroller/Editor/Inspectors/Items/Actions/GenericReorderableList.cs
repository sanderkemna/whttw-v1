...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Items.Actions
{
    ...
    public class GenericReorderableList<T> : VisualElement where T : class
    {
        ...
        public virtual void Setup(string title, Object target, Func<IList<T>> get, Action<IList<T>> set, SerializedProperty serializedProperty)
        {
            ...
            if (m_Get == null) {
                Debug.LogError("The Get function cannot be null.");
            }
            if (m_Set == null) {
                Debug.LogError("The Set function cannot be null.");
            }
        ...
        protected virtual bool DrawModule(int index)
        {
            if (index == -1) {
                m_DrawnModule = null;
            ...
            FieldInspectorView.AddFields(
                ...
                (object obj) =>
                {
                    ...
                    InvokeValueChanged();
                }, m_SerializedProperty.GetArrayElementAtIndex(index), null, true, null, LabelControl.WidthAdjustment.None, m_PropertiesToExclude, null);
        ...
        protected virtual void AddModule(object obj)
        {
        ...
        protected virtual void InvokeValueChanged(bool refresh = true)
        {
            m_Set(m_List);
            ...
            public virtual void Refresh()
            {
                ...
                for (int i = 0; i < m_InLineFields.Length; i++) {
                    ...
                    FieldInspectorView.AddField(m_Target, m_Module, fieldInfo, null, -1, fieldInfo.FieldType,
                        null, null, LabelControl.WidthAdjustment.None, value,
