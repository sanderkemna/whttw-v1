    ...
    public class MagicAction : UsableAction
    {
        ...
        public override void ItemUseComplete()
        {
            ...
            if (m_NetworkInfo != null && m_NetworkInfo.HasAuthority()) {
                m_NetworkCharacter.InvokeMagicCastEffectsModules(this, m_CastEffectsModuleGroup, invokedBitmask, Networking.Inventory.INetworkCharacterInventory.CastEffectState.End, m_MagicUseDataStream);
            }
#endif
        }
