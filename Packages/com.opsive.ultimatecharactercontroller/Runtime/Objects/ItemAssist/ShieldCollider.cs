...
#endif
            m_Collider.enabled = firstPersonPerspective == m_FirstPersonPerspective;

#if ULTIMATE_CHARACTER_CONTROLLER_MULTIPLAYER
            if (m_CharacterLocomotion.NetworkInfo == null || m_CharacterLocomotion.NetworkInfo.IsLocalPlayer() || m_CharacterLocomotion.NetworkInfo.IsSpectator()) {
#endif
