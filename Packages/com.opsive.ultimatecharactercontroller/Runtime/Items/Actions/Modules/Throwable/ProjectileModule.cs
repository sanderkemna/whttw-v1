...
namespace Opsive.UltimateCharacterController.Items.Actions.Modules.Throwable
{
    ...
    /// </summary>
    [Serializable]
    public abstract class ThrowableProjectileModule : ThrowableActionModule, IModuleCanActivateVisibleObject, IModuleStartItemUse, 
                                                        IModuleItemUseComplete, IModuleStopItemUse, IModuleOnChangePerspectives
    {
