...
namespace Opsive.UltimateCharacterController.Items.Actions
{
    ...
    public abstract class ItemPerspectiveProperty
    {
        ...
        {
            get {
                return m_CharacterItemAction.FirstPersonPerspective ?
#if FIRST_PERSON_CONTROLLER
                        FirstPersonObject
#else
                        null
        ...
        public bool FirstPersonPerspective => m_CharacterItemAction.FirstPersonPerspective;
        ...
        public virtual void Initialize(CharacterItemAction characterItemAction)
        {
            if (m_ModelManager != null) {
                Shared.Events.EventHandler.UnregisterEvent<GameObject>(m_ModelManager.gameObject, "OnCharacterSwitchModels", OnCharacterSwitchModels);
            }
    ...
    {
        public bool FirstPersonPerspective { get; }
        ...
        public T GetValue()
        {
            return GetValue(FirstPersonPerspective);
        }
        ...
        {
            SetValue(value, FirstPersonPerspective);
        }
    ...
    public class ItemPerspectiveProperty<T> : ItemPerspectiveProperty, IPerspectiveProperty<T>
    {
        ...
        public T GetValue()
        {
            ...
            return GetValue(m_CharacterItemAction.FirstPersonPerspective);
        }
        ...
        public void SetValue(T value)
        {
            ...
            SetValue(value, m_CharacterItemAction.FirstPersonPerspective);
        }
