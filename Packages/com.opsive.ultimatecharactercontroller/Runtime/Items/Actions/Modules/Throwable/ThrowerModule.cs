...
namespace Opsive.UltimateCharacterController.Items.Actions.Modules.Throwable
{
    ...
    public class ProjectileThrower : ThrowableThrowerModule
    {
        ...
        {
            m_CharacterItemAction.DebugLogger.Log(this,"Throw");
        ...
        protected virtual void ThrowInternal(ThrowableUseDataStream dataStream)
        {
            ...
            if (!projectileData.AmmoData.Valid) {
                m_CharacterItemAction.DebugLogger.Log(this, "No ammo to throw.");
                return;
            }
            ...
            var velocity = MathUtility.TransformDirection(m_Velocity, Quaternion.LookRotation(lookDirection, CharacterTransform.up)) * dataStream.TriggerData.Force;
