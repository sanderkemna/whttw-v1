...
namespace Opsive.UltimateCharacterController.FirstPersonController.Camera
{
    ...
    public class MaterialSwapper : MonoBehaviour
    {
                    ...
                    if ((m_SwapMask & SwapMask.FirstPerson) != 0) {
                        ...
                        if (firstPersonObject != null) {
                            ...
                            for (int j = 0; j < renderers.Length; ++j) {
                                renderers[j].materials = m_FirstPersonInvisibleMaterials[j];
                            }
                        }
                    }
        ...
        private void BeginCameraRendering(UnityEngine.Rendering.ScriptableRenderContext context, Camera renderCamera)
#else
...
#if ULTIMATE_CHARACTER_CONTROLLER_UNIVERSALRP || ULTIMATE_CHARACTER_CONTROLLER_HDRP
        /// <param name="context">The context of the SRP.</param>
        private void EndCameraRendering(UnityEngine.Rendering.ScriptableRenderContext context, Camera renderCamera)
#else
