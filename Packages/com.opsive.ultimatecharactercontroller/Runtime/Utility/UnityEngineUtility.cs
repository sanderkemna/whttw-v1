...
namespace Opsive.UltimateCharacterController.Utility
{
    ...
    public class UnityEngineUtility
    {
        ...
        /// <summary>
        /// Returns the active render pipeline.
        /// </summary>
        /// <returns>The active render pipeline.</returns>
        public static RenderPipeline GetActiveRenderPipeline()
        {
            ...
            if (GraphicsSettings.currentRenderPipeline != null && GraphicsSettings.currentRenderPipeline.GetType().FullName.Contains("HighDefinition")) {
...
#pragma warning restore 0649
    ...
    public struct OriginalMaterialValue
    {
        ...
        /// <param name="modeID">The ID of the mode property.</param>
        public void Initialize(Material material, int colorID, int modeID)
        {
