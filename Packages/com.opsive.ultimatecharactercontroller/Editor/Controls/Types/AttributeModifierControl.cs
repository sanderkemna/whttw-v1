    ...
    public class AttributeModifierControl : TypeControlBase
    {
        ...
        protected override VisualElement GetControl(TypeControlInput input)
        {
            ...
            if (attributeManager != null) {
                ...
                var labelControl = new LabelControl(label, Shared.Editor.Utility.EditorUtility.GetTooltip(input.Field), dropdownField, LabelControl.WidthAdjustment.UnityDefault);
                ...
                var labelControl = new LabelControl(label, Shared.Editor.Utility.EditorUtility.GetTooltip(input.Field), textField, LabelControl.WidthAdjustment.UnityDefault);
                container.Add(labelControl);
