...
namespace Opsive.UltimateCharacterController.Character
{
    ...
    public class ModelManager : MonoBehaviour
    {
            ...
            )
        {
            ...
            var originalAnimationMonitor = m_ActiveModel.GetCachedComponent<AnimationMonitorBase>();
            var targetAnimationMonitor = targetModel.GetCachedComponent<AnimationMonitorBase>();

#if FIRST_PERSON_CONTROLLER
            var targetFirstPersonObjects = GetFirstPersonObjects(targetModel);
#endif

            Shared.StateSystem.StateManager.SetState(m_GameObject, m_ActiveModel.name, false);
            ...
            if (targetFirstPersonObjects != null) {
                ...
                for (int i = 0; i < targetChildAnimationMonitors.Length; ++i) {
                    targetChildAnimationMonitors[i].CopyParameters(originalAnimationMonitor);
                }
            }
#endif
        }
