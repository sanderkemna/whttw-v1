...
namespace Opsive.UltimateCharacterController.Networking.Inventory
{
    ...
    public interface INetworkCharacterInventory
    {
        ...
        /// <param name="newAmount">The new amount of ItemIdentifier.</param>
        /// <param name="immediatePickup">Was the item be picked up immediately?</param>
        /// <param name="forceEquip">Should the item be force equipped?</param>
        void ItemIdentifierPickup(uint itemIdentifierID, int slotID, int newAmount, bool immediatePickup, bool forceEquip);
        ...
        void RemoveItemIdentifierAmount(uint itemIdentifierID, int slotID, int newAmount, bool drop, bool removeCharacterItem, bool destroyCharacterItem);
