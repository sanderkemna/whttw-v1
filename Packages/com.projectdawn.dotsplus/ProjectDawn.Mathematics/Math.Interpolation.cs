...
namespace ProjectDawn.Mathematics
{
    ...
    public static partial class math2
    {
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double invlerp(double start, double end, double value) => saturate((value - start) / (end - start));
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2 invlerp(double2 start, double2 end, double2 value) => saturate((value - start) / (end - start));
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double3 invlerp(double3 start, double3 end, double3 value) => saturate((value - start) / (end - start));
