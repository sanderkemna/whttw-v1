...
namespace Opsive.Shared.Input
{
        ...
        IPlayerInput
    {
        ...
        protected Vector3 m_RawLookVectorAccumulation;
        protected Vector3 m_UnitySmoothLookVectorAccumulation;
        ...
        public virtual void RegisterEvents(GameObject targetGameObject)
        {
            if (m_GameObject == targetGameObject) {
                return;
            }
        ...
        { 
            if (waitForDoublePressTapTimeout) {
            ...
            return GetButtonDownInternal(buttonName);
        }
        ...
        protected virtual void UpdateInput(string horizontalInputName, string verticalInputName, float multiplier)
        {
        ...
        /// <summary>
        /// Unregisters for the events on the specified GameObject.
        /// </summary>
