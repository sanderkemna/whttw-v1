...
namespace Opsive.UltimateCharacterController.Editor.Controls.Types.ViewTypeDrawers.ThirdPerson
{
    ...
    public class TopDownControl : ViewTypeDrawer
    {
        ...
        public override void CreateDrawer(UnityEngine.Object unityObject, object target, VisualElement container, System.Func<System.Reflection.FieldInfo, object, bool> onValidateChange, System.Action<object> onChangeEvent)
        {
            ...
            cameraRotationContainer.style.display = (target as TopDown).AllowDynamicCameraRotation ? DisplayStyle.Flex : DisplayStyle.None;
            ...
            dynamicPitchContainer.style.display = (target as TopDown).AllowDynamicPitchAdjustment ? DisplayStyle.Flex : DisplayStyle.None;
            ...
            dynamicDistanceContainer.style.display = (target as TopDown).AllowDynamicPitchAdjustment ? DisplayStyle.Flex : DisplayStyle.None;
