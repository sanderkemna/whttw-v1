...
namespace ProjectDawn.Mathematics
{
    ...
    public static partial class math2
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool even(this double value) => ((int)value  & 1) != 1;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool2 even(this double2 value) => ((int2)value & 1) != 1;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool3 even(this double3 value) => ((int3)value & 1) != 1;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool4 even(this double4 value) => ((int4)value & 1) != 1;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool  odd(this double value) => ((int)value  & 1) != 0;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool2 odd(this double2 value) => ((int2)value & 1) != 0;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool3 odd(this double3 value) => ((int3)value & 1) != 0;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool4 odd(this double4 value) => ((int4)value & 1) != 0;
