...
namespace ProjectDawn.Geometry3D
{
    ...
    public partial struct Box : IEquatable<Box>
    {
        ...
        /// <inheritdoc />
        public override bool Equals(object other) => other is Box shape && Equals(shape);
       ...
       //public bool Overlap(Line line) => ShapeUtility.OverlapBoxAndLine(this, line);
        ...
        /// Returns true if shapes surfaces overlap.
        /// </summary>
        public bool Overlap(Box box, float4x4 transform) => ShapeUtility.OverlapBoxAndBox(this, box, transform);
        ...
        /// </summary>
        public bool Overlap(Triangle triangle) => ShapeUtility.OverlapBoxAndTriangle(this, triangle);
